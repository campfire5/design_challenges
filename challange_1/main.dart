                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(12.5), color: const Color.fromARGB(255, 206, 232, 174)),
                    ),
                    Align(
...
class CustomShapePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path()
      ...
      ..quadraticBezierTo(size.width, size.height - arcDimension, size.width - arcDimension, size.height - arcDimension)
